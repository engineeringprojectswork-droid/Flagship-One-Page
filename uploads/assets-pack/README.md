...
| sheep-app (P3) | ✅ all delivery facts + schema | ⏳ 4 app/CI shots → `_TO-CAPTURE` |
...
## What's left
See `_TO-CAPTURE/CAPTURE-THESE.md` — live-app/login shots only (sheep-app, medmac-website + Lighthouse, optional Ads Manager / followers / rfq). Nothing blocks the build; these can be dropped in later.
